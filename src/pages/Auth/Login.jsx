...
const Login = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            setLoading(true)
            let response = await ApiClass.postRequest('admin/login', false, values);
            setLoading(false)
            ...
            if (response?.data?.code == "0000") {
                ...
                localStorage.setItem('_user', JSON.stringify(response?.data?.data?.user));
                resetForm()
                navigate('/dashboard');
            }
        }
                        ...
                        <div className="col-sm-9 col-md-6 col-xl-4 col-xxl-3">
                            <div className="auth-box rounded">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="mb-3">
                                            <div className="input-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="Enter Email" name="email" defaultValue={values.email} onChange={handleChange} />
                                            </div>
                                        ...
                                        <div className="mb-3">
                                            <div className="input-group">
                                                ...
                                                <input id="login_password" type="password" className="form-control" placeholder="Enter Password" name="password" defaultValue={values.password} onChange={handleChange} />
                                                <span className="input-group-text">
                                ...
                                <div className="forgot text-center p-3">
                                    <Link to="/" className="text-decoration-none text-capitalize">I am Strong</Link>
                                </div>
                            </div>
                        </div>
                    </div>
